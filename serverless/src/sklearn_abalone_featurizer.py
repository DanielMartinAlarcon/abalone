...
if __name__ == "__main__":
    ...
    # This section is adapted from the scikit-learn
    # example of using preprocessing pipelines:
    #
    # https://scikit-learn.org/stable/auto_examples/compose/
    # plot_column_transformer_mixed_types.html
    #
...
def output_fn(prediction, accept):
    ...
    The default accept/content-type between containers
    for serial inference is JSON.
    We also want to set the ContentType or mimetype as the
    same value as accept so the next
...
def predict_fn(input_data, model):
    ...
    We implement this because the default predict_fn uses .predict(),
    but our model is a preprocessor
